...
5. For visual verification, run the cljs convolution demo manually: run `sudo nvidia-docker run -p 80:3001 -d graphistry/cljs:1.0` and then go to `257.257.257.257/?mode=opencl`.
